...
history=model.fit(train_images , y_train , epochs=250, batch_size=32) 
...
print('Cross Entropy Accuracy :' , (Results[1]))
print('Cross EntropyLoss :' , (Results[0]))
...
d=np.count_nonzero(y_test == 0,axis = 0)
